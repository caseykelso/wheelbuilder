...
public class basicCyclocrossActivity extends basicActivity
{
    ...
    public void populateRimModelSpinner(int brand)
    {
            ...
            if (brand != rimBrandIndex)
            {
                ...
                List<Rim> rimList = dbAdapter.getRimsOfBrand(brand, "cyclocross");
    ...
    public void populateHubModelSpinner(int brandIndex)
    {
        ...
        if (brandIndex != hubBrandIndex)
        {
            ...
            try
            {
            List<Hub> hubModelList = dbAdapter.getHubsOfBrand(brandIndex, "cyclocross");
     ...
     public void populateHubBrandSpinner()
    {
        ...
        try 
        {
            ...
            List<Brand> hubBrandList = dbAdapter.getHubBrands("cyclocross");
