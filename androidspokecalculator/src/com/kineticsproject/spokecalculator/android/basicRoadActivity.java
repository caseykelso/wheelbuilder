...
public class basicRoadActivity extends basicActivity
{
    ...
    public void populateRimModelSpinner(int brand)
    {
            ...
            if (brand != rimBrandIndex)
            {
                ...
                List<Rim> rimList = dbAdapter.getRimsOfBrand(brand, "road");
    ...
    public void populateHubModelSpinner(int brandIndex)
    {
        ...
        if (brandIndex != hubBrandIndex)
        {
            ...
            try
            {
            List<Hub> hubModelList = dbAdapter.getHubsOfBrand(brandIndex, "road");
     ...
     public void populateHubBrandSpinner()
    {
        ...
        try 
        {
            ...
            List<Brand> hubBrandList = dbAdapter.getHubBrands("road");
